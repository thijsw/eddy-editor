 ...
 * `ToolbarItem`s have their Vue-specific Lucide icons attached here so that
 * the toolbar stays framework-agnostic and unused plugin icons tree-shake
 * out of the consumer bundle.
 */
function withIcon(plugin: EddyPlugin, iconByCommand: Record<string, Component>): EddyPlugin {
